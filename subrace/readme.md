...
Half gray orcs have the following traits:  
– Movement speed is 2 points higher than normal (default is 9)  
– +1 Wisdom, -1 Constitution, -1 Charisma  
– Can track by sense of smell, resulting in a +1 bonus to Saving Throws and Armor Class  
– Light Blindness: -1 penalty to THAC0 and Saving Throws while under sunlight  
– Gets only 95% of all experience gained  
